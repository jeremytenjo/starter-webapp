...
var Wrapper = _styledComponents["default"].div.withConfig({
  displayName: "buttonstyle1styles__Wrapper",
  componentId: "dc6ucz-0"
})(["background-color:", ";border-radius:100px;cursor:pointer;padding:var(--spacing-s);display:flex;align-items:center;justify-content:center;text-align:center;transition:0.2s ease-in-out;height:40px;border:2px solid ", ";user-select:none;&:active{border:2px solid ", ";}", " ", " ", " ", " ", ""], function (_ref) {
