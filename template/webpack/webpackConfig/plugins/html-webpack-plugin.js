...
module.exports = function(project_name, project_desc, theme) {
  return new HtmlWebpackPlugin({
    ...
    bodyHtmlSnippet:
      '<img id="splashPage" style="position: fixed; top: 0; right: 0; bottom: 0; left: 0; margin: auto; width: 100px; z-index: -2;" src="/images/public/icon_167x167.png"><noscript>You need to enable JavaScript to run this app.</noscript>',
